                    ...
                    <div class="card-footer bg-light border-top border-light p-4 rounded-bottom-4">
                        ...
                        <form method="POST" 
                            ...
                            <div id="section-cash" class="mb-3 p-3 rounded" style="background-color: #f7f4ef; border: 1px solid #e8e3dc;">
                                ...
                                <!-- Memastikan name atribut mencakup nama variabel yang sering dipakai Controller (cash_given / bayar) -->
...
<script>
    ...
    function togglePaymentSection() {
        ...
        if (method === 'CASH') {
            ...
            inputCash.value = grandTotal; // Set otomatis pas bayar via QRIS
        }
        calculateChange();
    }
