                ...
                <div class="pos-card h-100 d-flex flex-column">
                    ...
                    <div class="card-footer bg-light border-top border-light p-4 rounded-bottom-4">
                        ...
                        <form method="POST" 
                              ...
                              onsubmit="return validatePayment()" class="mb-2">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="payment_method" id="metode_pembayaran" class="form-select shadow-sm" required style="border-radius: 12px; border: 2px solid #f0eae1;" onchange="togglePaymentSection()">
...
<script>
    ...
    function togglePaymentSection() {
        ...
        const inputCash = document.getElementById('cash_given');
    ...
    // Panggil fungsi saat dokumen selesai dimuat untuk sinkronisasi state awal
